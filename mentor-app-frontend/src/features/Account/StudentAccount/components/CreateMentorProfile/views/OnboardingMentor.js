...
const OnboardingMentor = ({graphQLClient}) => {
  ...
  return (
    <div className={customClasses.transparentContainer}>
      ...
      <Switch>
        <Route
          path="/student-account/create-mentor/basic"
          component={() => (
        ...
        <Route
          path="/student-account/create-mentor/personal"
          component={() => (
        ...
        <Route
          path="/student-account/create-mentor/interests"
          component={() => (
            <MentorProfileInterests setActiveStep={setActiveStep} graphQLClient={graphQLClient} />
          )}
        />
      </Switch>
    </div>
